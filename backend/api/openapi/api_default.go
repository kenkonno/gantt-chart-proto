...
// PostBulkUpdateTickets - PostBulkUpdateTickets
func PostBulkUpdateTickets(c *gin.Context) {
	var r openapi_models.PostBulkUpdateTicketsResponse
	r, err := bulk_update_tickets.PostBulkUpdateTicketsInvoke(c)
	if err != nil {
	} else {
		c.JSON(http.StatusOK, r)
	}
...
// PostUnitsDuplicate - DuplicateUnit
func PostUnitsDuplicate(c *gin.Context) {
	var r openapi_models.PostUnitsDuplicateResponse
	r, err := units_duplicate.PostUnitsDuplicateInvoke(c)
	if err != nil {
	} else {
		c.JSON(http.StatusOK, r)
	}
