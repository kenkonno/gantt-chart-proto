...
func NewPileUpsRepository() pileUpsRepository {
	return pileUpsRepository{con}
}
...
func (r *pileUpsRepository) GetDefaultPileUps(excludeFacilityId int32, facilityTypes []string) []db.DefaultPileUp {
	...
	`, excludeFacilityId, createInParam(facilityTypes), excludeFacilityId, createInParam(facilityTypes))).Scan(&results)
